...
router.post('/api/classroom/:id', classroomController.add)
...
router.post('api/classroom/add-with-students', classroomController.addWithStudents)
router.post('/api/lecturer/add-with-course', lecturerController.addWithCourse)